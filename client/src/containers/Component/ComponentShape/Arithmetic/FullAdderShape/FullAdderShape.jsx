...
const FullAdderShape = ({
  ...
  return (
    ...
    >
      ...
      <Text x={0.05 * dimension} y={0.5 * height} text="B" fill="#FFFFFF"/>
      <Text x={0.05 * dimension} y={0.8 * height} text="Cin" fill="#FFFFFF"/>
      <Text x={0.8  * dimension} y={0.2 * height} text="S" fill="#FFFFFF"/>
      <Text x={0.8  * dimension} y={0.7 * height} text="Cout" fill="#FFFFFF"/>
    </Group>
  );
};
  
export default FullAdderShape;