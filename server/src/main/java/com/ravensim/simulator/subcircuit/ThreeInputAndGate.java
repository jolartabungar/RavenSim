...
public class ThreeInputAndGate extends SubCircuit 
{

  public ThreeInputAndGate(SimulationEngine ctx, List<Port> inputs, List<Port> outputs)
  ...
  protected void build(SimulationEngine ctx, List<Port> inputs, List<Port> outputs)
          ...
          InvalidBitWidthException 
    {
        ...
        var d     = io.getOutput();    
        // Create the circuit 
        new AndGate(ctx, List.of(a,b,c), d);
    }
}
