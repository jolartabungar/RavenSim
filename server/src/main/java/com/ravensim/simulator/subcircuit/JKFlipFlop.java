...
public class JKFlipFlop extends SubCircuit 
{

  public JKFlipFlop(SimulationEngine ctx, List<Port> inputs, List<Port> outputs)
          ...
          InvalidBitWidthException 
  {
    ...
    // Create the circuit 
    new NandGate(ctx, List.of(clock,j,t6), t0);
    new NandGate(ctx, List.of(clock,k,t7), t3);
    new NandGate(ctx, List.of(t1,t2), q);
    new NandGate(ctx, List.of(t4,t5), q_not);
