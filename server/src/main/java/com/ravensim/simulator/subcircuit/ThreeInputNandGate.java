...
public class ThreeInputNandGate extends SubCircuit 
{
  public ThreeInputNandGate(SimulationEngine ctx, List<Port> inputs, List<Port> outputs)
  ...
  protected void build(SimulationEngine ctx, List<Port> inputs, List<Port> outputs)
          ...
          InvalidBitWidthException 
    {
        ...
        var d     = io.getOutput();    
        // Create the circuit 
        new NandGate(ctx, List.of(a,b,c), d);
    }
}
