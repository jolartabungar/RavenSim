...
public class ThreeInputOrGate extends SubCircuit 
{
  public ThreeInputOrGate(SimulationEngine ctx, List<Port> inputs, List<Port> outputs)
  ...
  protected void build(SimulationEngine ctx, List<Port> inputs, List<Port> outputs)
          ...
          InvalidBitWidthException 
    {
        ...
        var d     = io.getOutput();    
        // Create the circuit 
        new OrGate(ctx, List.of(a,b,c), d);
    }
}
