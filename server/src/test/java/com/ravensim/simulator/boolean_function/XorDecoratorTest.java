...
class XorDecoratorTest {
  ...
  void constructor_nullBooleanFunctionToBeDecorated() {
    Assertions.assertThrows(
        ...
        () -> new XorDecorator(null, new Port(context), new Port(context), new Port(context)));
  }
  ...
  void constructor_nullInput0() {
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new XorDecorator(simpleBooleanFunction, null, new Port(context), new Port(context)));
  }
  ...
  void constructor_nullInput1() {
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new XorDecorator(simpleBooleanFunction, new Port(context), null, new Port(context)));
  }
  ...
  void constructor_nullOutput() {
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new XorDecorator(simpleBooleanFunction, new Port(context), new Port(context), null));
  }
  ...
  void constructor_nullInput0AndOutput() {
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new XorDecorator(simpleBooleanFunction, null, new Port(context), null));
  }
  ...
  void constructor_nullInput1AndOutput() {
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new XorDecorator(simpleBooleanFunction, new Port(context), null, null));
  }
  ...
  void constructor_nullInput0AndInput1() {
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new XorDecorator(simpleBooleanFunction, null, null, new Port(context)));
  }
  ...
  void constructor_nullInputsAndOutput() {
    Assertions.assertThrows(
        NullPointerException.class,
        () -> new XorDecorator(simpleBooleanFunction, null, null, null));
  }
  ...
  void evaluate_invokeEvaluateOnSimpleBooleanFunction()
    ...
    new XorDecorator(simpleBooleanFunction, new Port(context), new Port(context), new Port(context))
        .evaluate();
  ...
  void evaluate_invokeSuperEvaluateBeforeEvaluatingSelf()
      throws InvalidBitWidthException, IncompatibleBitWidthsException {
    var operator = Mockito.mock(XorOperator.class);
    var xorDecorator =
        new XorDecorator(
            simpleBooleanFunction, new Port(context), new Port(context), new Port(context));
    ReflectionTestUtils.setField(xorDecorator, "function", operator);
    var inOrder = Mockito.inOrder(simpleBooleanFunction, operator);
    xorDecorator.evaluate();
  ...
  void evaluate_isCorrectOutput()
    ...
    new XorDecorator(simpleBooleanFunction, input0, input1, output).evaluate();
